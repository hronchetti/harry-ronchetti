  ...
  <header className="w-full text-center">
    <div className="relative overflow-hidden">
      <div className="wrapper-x flex flex-wrap justify-center pb-10 pt-6 md:pb-12 md:pt-12 lg:pb-20 lg:pt-16 xl:pb-24">
        <span className="mb-5 block rounded-lg border border-grey-30 bg-grey-20 px-2 py-1 text-sm font-medium uppercase tracking-widest text-grey-70 sm:mb-6 xl:mb-7">
