    ...
    return (
      <>
        ...
        <span className={`inline-block ${padding} relative`}>
          ...
          <span
            className={`absolute h-full bg-yellow ${rounded} left-0 top-0 z-[-1] will-change-transform transition-all duration-300 ease-[cubic-bezier(.22,.68,0,1.5)] delay-600 ${
