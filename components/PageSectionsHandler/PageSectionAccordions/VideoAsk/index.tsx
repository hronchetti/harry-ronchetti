...
export const VideoAsk = () => (
  <div className="relative md:py-12">
    ...
    <iframe
      ...
      className="rounded-3xl max-w-[576px] mx-auto z-20 md:absolute md:-translate-y-1/2 md:top-1/2 md:left-1/2 md:-translate-x-1/2 shadow-[0_8px_48px_-12px_rgba(18,25,38,0.16)] bg-white"
      src="https://www.videoask.com/fdxpb5f8f"
