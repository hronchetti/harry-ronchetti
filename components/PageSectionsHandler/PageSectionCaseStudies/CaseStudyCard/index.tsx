...
export const CaseStudyCard = ({
  ...
  <TrackVisibility tag="section" once partialVisibility>
    {({ isVisible }) => (
      <a
        className={`block overflow-hidden bg-grey-90 rounded-8 lg:rounded-16 2xl:rounded-20 group lg:grid lg:grid-cols-2 will-change-transform transition-all duration-300 ease-out delay-300 ${
